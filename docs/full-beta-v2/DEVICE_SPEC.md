...
> between the two comparators (`SUPPLEMENT_CYCLE`), the cell still supplying the shortfall
> on a duty cycle; the model carries the cycle at its floor, the adverse end for heat.  So
