...
| item | MPN | qty | evidence |
|---|---|---|---|
| **U.FL/MHF-I → SMA female bulkhead pigtail** | **Amphenol RF `095-902-568-100`** *(supersedes `095-902-568-150`, D-218)* | 1 | Amphenol RF product page 2026-08-23: **Part Status ACTIVE**. AMC right-angle plug → **SMA straight bulkhead jack, IP67**, **RG-178**, **50 Ω**, **100 mm**, **6 GHz** max, RoHS (exemption 6C). **Re-verified live 2026-08-24 (D-096): Part Status ACTIVE; Connector A SMA jack, panel-mount bulkhead, front-side nut; Connector B U.FL (UMCC) / AMC plug, right angle, free hanging; RG-178; 50 Ω; 100.00 mm; 6 GHz.** IP67 is carried from the series data (D-195) — the manufacturer page refuses to serve in this environment and was not re-read. **PROCUREMENT: 0 in stock with a 12-week factory lead time and no JLCPCB listing — order early.** **MECHANICAL WARNING (D-218): the FBV2-P1 floorplan measures a ≈ 190 mm routed run from `U8` to a top-panel SMA, so 100 mm is SHORT BY ≈ 90 mm and the superseded 150 mm is short by ≈ 40 mm. DO NOT ORDER until the CTO has ruled on the 915 MHz feed.** Amphenol's AMC series is **"compatible with Hirose U.FL and IPEX MHF1"** |
...
separate bulkhead MPN is needed.** Loss at 915 MHz is ≈ **0.4 dB** (RG-178 ≈ 1.2 dB/m × 0.10 m
