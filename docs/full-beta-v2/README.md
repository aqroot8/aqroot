...
| [pcb/FBV2_P2_POWER_ROUTING.md](pcb/FBV2_P2_POWER_ROUTING.md) | **FBV2-P2 power routing.** The In1 GND plane, the placement corrections the routing exposed, the B-34 recomputation, and an honest account of why the first routing attempt was reverted. |
| [audits/2026-08-24-p2-battery-protection-routing.md](audits/2026-08-24-p2-battery-protection-routing.md) | **FBV2-P2-002A.** The obstacle-aware routing method, the D-245 width ruling, the routing journal, and the three named router defects that remain. |
