...
GROUPS = {
    ...
    'XGPIO3_INNER': dict(
        sheet='09_COMMUNITY_HEADER', desc='XGPIO3 D-331 inner-haul reuse screen',
        layer='F', width=200000, clr_pad=200000, clr_trk=200000,
        via_dia=600000, via_drill=300000,
        inner_long_haul_plan=dict(a='R54.1', b='U3.7',
                                  a_near='F', b_near='B',
                                  inner=['I2', 'I3']),
        nets=['XGPIO3'],
    ),
    ...
    'XGPIO0_INNER': dict(
        sheet='09_COMMUNITY_HEADER', desc='XGPIO0 D-331 inner-haul reuse screen',
        layer='F', width=200000, clr_pad=200000, clr_trk=200000,
        via_dia=600000, via_drill=300000,
        inner_long_haul_plan=dict(a='R51.1', b='U3.4',
                                  a_near='F', b_near='B',
                                  inner=['I2', 'I3']),
        nets=['XGPIO0'],
    ),
