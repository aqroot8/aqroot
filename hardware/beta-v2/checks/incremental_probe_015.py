...
def main():
    ...
    # copper is Phase-A (432) + all nine prior rest increments (176) = 599 tracks
    # + 62 vias.
    ...
    chk('non-XGPIO pre-D-313 copper == 599 tracks + 62 vias (all prior increments intact)',
        sum(prior_now.values()) == 599 + 62,
