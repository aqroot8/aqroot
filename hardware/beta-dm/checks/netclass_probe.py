"""Beta-DM netclass regression probe.

Run:  python hardware/beta-dm/checks/netclass_probe.py
...
PRO = os.path.join(HERE, '..', 'kicad', 'aqroot-beta-dm', 'aqroot-Beta-DM.kicad_pro')
PCB = os.path.join(HERE, '..', 'kicad', 'aqroot-beta-dm', 'aqroot-Beta-DM.kicad_pcb')
