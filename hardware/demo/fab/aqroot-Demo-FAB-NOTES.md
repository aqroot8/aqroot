...
- Published delivery, DERIVED by `demo_feature_contract` F6 over every permitted wiring and load mode: **2.805637 V** at the full 400 mA in the worst permitted mode (one 3.3 V contact alone, one mated ground, the 5 V rail also at its 300 mA budget), and **2.910494 V** with the header fully mated.
