...
- First article: **C-ACC-01** measures the delivered potential at the J5 mating interface for each contact alone and for the fully mated header -- SIZING / DIAGNOSTIC readings (400 mA single-rail, and the 400 mA + 300 mA shared-ground sizing case held only for the reading), NOT operating modes: both rails together are supported only at the declared 220 mA + 170 mA pair (D-803); **C-ACC-02** records the two routed resistances.
