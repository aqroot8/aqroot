#!/usr/bin/env python3
"""Atomically route and gate the fitted IR receiver signal tree."""
...
NET = "/IR_RX_GPIO44"
LEGS = ("IR_RX_MCU_TP", "IR_RX_TP_RECEIVER")
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix="aqroot-demo-ir-rx-") as td:
