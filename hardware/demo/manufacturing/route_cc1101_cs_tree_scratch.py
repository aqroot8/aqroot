#!/usr/bin/env python3
"""Atomically route and gate the fitted CC1101 chip-select tree."""
...
NET = "/CC1101_CS_N"
LEGS = ("CC1101_CS_MCU_PULLUP", "CC1101_CS_MCU_RADIO")
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix="aqroot-demo-cc1101-cs-") as temporary:
        cases = [run_case(Path(temporary), order, baseline)
