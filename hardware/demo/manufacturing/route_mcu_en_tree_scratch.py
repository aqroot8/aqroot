#!/usr/bin/env python3
"""Atomically route and gate the fitted ESP32 EN reset RC tree."""
...
NET = "Net-(U1-EN)"
LEGS = ("MCU_EN_U1_C1", "MCU_EN_C1_R1")
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix="aqroot-demo-mcu-en-") as temporary:
