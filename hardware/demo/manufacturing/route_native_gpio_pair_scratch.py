#!/usr/bin/env python3
"""Route and gate the two retained Demo native-GPIO internal legs atomically."""
...
LOCAL = ROOT / "hardware/demo/manufacturing/route_local_two_pad.py"
LEDGER = ROOT / "hardware/demo/manufacturing/routing_ledger.py"
NETS = ("/NATIVE_A", "/NATIVE_B")
ORDERS = {
    "a-first": ("NATIVE_A", "NATIVE_B"),
    "b-first": ("NATIVE_B", "NATIVE_A"),
}
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix="aqroot-demo-native-gpio-") as temporary:
        work = Path(temporary)
