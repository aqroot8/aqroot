#!/usr/bin/env python3
"""Route and fully gate the retained TPS63020 PS/SYNC configuration tree."""
...
NET = "Net-(U12-PS_SYNC)"
ORDERS = {
    "ic-first": ("U12_PS_SYNC_PULLDOWN_IC", "U12_PS_SYNC_PULLDOWN_TP"),
    "tp-first": ("U12_PS_SYNC_PULLDOWN_TP", "U12_PS_SYNC_PULLDOWN_IC"),
}
INNER_ORDERS = {
    "inner-ic-first": ("U12_PS_SYNC_PULLDOWN_IC_INNER", "U12_PS_SYNC_PULLDOWN_TP"),
    "inner-tp-first": ("U12_PS_SYNC_PULLDOWN_TP", "U12_PS_SYNC_PULLDOWN_IC_INNER"),
}
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix="aqroot-demo-u12-ps-sync-preflight-") as temporary:
        ...
        if row["open_edges"] == 0:
            ...
            return 0
    with tempfile.TemporaryDirectory(prefix="aqroot-demo-u12-ps-sync-") as temporary:
        families = {**ORDERS, **INNER_ORDERS}
        cases = [run_case(Path(temporary), order, legs, baseline)
                 for order, legs in families.items()]
