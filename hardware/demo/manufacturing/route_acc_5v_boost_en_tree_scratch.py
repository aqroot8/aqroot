#!/usr/bin/env python3
"""Atomically route and gate the retained ACC_5V_BOOST_EN control tree."""
...
def run_case(work, order, baseline):
    ...
    return {
        "order": order, "routes": routes, "drc_types": dict(types),
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix="aqroot-demo-boost-en-") as temporary:
        work = Path(temporary)
