#!/usr/bin/env python3
"""D-792 -- re-sweep every exact MPN on the RELEASED assembly BOM, live.
...
it cannot.
    ...
    python3 evidence/d792-sweep-sourcing.py [-o evidence/d792-sourcing-sweep.json]
...
OUT = ROOT / "hardware/demo/manufacturing/evidence/d792-sourcing-sweep.json"
FIRST_FIVE = 5
