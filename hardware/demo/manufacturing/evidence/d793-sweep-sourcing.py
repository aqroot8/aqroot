#!/usr/bin/env python3
"""D-793 -- re-sweep every exact MPN on the RELEASED assembly BOM, live.
...
it cannot.
    ...
    python3 evidence/d793-sweep-sourcing.py [-o evidence/d793-sourcing-sweep.json]
...
OUT = ROOT / "hardware/demo/manufacturing/evidence/d793-sourcing-sweep.json"
FIRST_FIVE = 5
