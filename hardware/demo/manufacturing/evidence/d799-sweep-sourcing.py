#!/usr/bin/env python3
"""D-799 -- re-sweep every exact MPN on the RELEASED assembly BOM, live.
...
it cannot.
    ...
    python3 evidence/d799-sweep-sourcing.py [-o evidence/d799-sourcing-sweep.json]
...
OUT = ROOT / "hardware/demo/manufacturing/evidence/d799-sourcing-sweep.json"
FIRST_FIVE = 5
