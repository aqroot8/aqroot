#!/bin/bash
# D-709 -- rebuild the PROMOTED transaction (run r9) from the PRE-promotion
# authority eca81247.  Promoted by D-709; see evidence/d709-summary.json.
#
...
#
# D-708 held it out of promotion on ONE clause measured HEAD -> candidate:
...
# D-709 FOUND THE CLAUSE WAS WRONG -- it compared the MIN-priced pad to the
# MAX-barred pad, two DIFFERENT pads -- repaired PP2 per pad plus a new
# sum-at-the-boundary term, and PROMOTED this board.  Authority 4414da31.
#
