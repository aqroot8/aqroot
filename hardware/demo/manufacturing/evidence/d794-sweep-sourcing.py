#!/usr/bin/env python3
"""D-794 -- re-sweep every exact MPN on the RELEASED assembly BOM, live.
...
it cannot.
    ...
    python3 evidence/d794-sweep-sourcing.py [-o evidence/d794-sourcing-sweep.json]
...
OUT = ROOT / "hardware/demo/manufacturing/evidence/d794-sourcing-sweep.json"
FIRST_FIVE = 5
