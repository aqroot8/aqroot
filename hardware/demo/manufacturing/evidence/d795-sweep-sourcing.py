#!/usr/bin/env python3
"""D-795 -- re-sweep every exact MPN on the RELEASED assembly BOM, live.
...
it cannot.
    ...
    python3 evidence/d795-sweep-sourcing.py [-o evidence/d795-sourcing-sweep.json]
...
OUT = ROOT / "hardware/demo/manufacturing/evidence/d795-sourcing-sweep.json"
FIRST_FIVE = 5
