#!/usr/bin/env python3
"""D-798 -- re-sweep every exact MPN on the RELEASED assembly BOM, live.
...
it cannot.
    ...
    python3 evidence/d798-sweep-sourcing.py [-o evidence/d798-sourcing-sweep.json]
...
OUT = ROOT / "hardware/demo/manufacturing/evidence/d798-sourcing-sweep.json"
FIRST_FIVE = 5
