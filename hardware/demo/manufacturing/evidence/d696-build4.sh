...
python3 $D/deltrk.py /tmp/c2.kicad_pcb $D/n0.kicad_pcb 66.1,100.0 2>/dev/null
cp $D/base.kicad_dru $D/n0.kicad_dru; cp $D/base.kicad_pro $D/n0.kicad_pro
