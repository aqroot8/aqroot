#!/usr/bin/env python3
"""D-800 -- re-sweep every exact MPN on the RELEASED assembly BOM, live.
...
it cannot.
    ...
    python3 evidence/d800-sweep-sourcing.py [-o evidence/d800-sourcing-sweep.json]
...
OUT = ROOT / "hardware/demo/manufacturing/evidence/d800-sourcing-sweep.json"
FIRST_FIVE = 5
