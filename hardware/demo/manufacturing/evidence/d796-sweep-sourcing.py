#!/usr/bin/env python3
"""D-796 -- re-sweep every exact MPN on the RELEASED assembly BOM, live.
...
it cannot.
    ...
    python3 evidence/d796-sweep-sourcing.py [-o evidence/d796-sourcing-sweep.json]
...
OUT = ROOT / "hardware/demo/manufacturing/evidence/d796-sourcing-sweep.json"
FIRST_FIVE = 5
