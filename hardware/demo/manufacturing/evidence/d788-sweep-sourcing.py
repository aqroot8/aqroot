#!/usr/bin/env python3
"""D-788 -- re-sweep every exact MPN on the RELEASED assembly BOM, live.

R7-N05 found the D-788 sweep carrying `R40 = ARG03BTC1783` -- the D-787 part --
...
it cannot.
    ...
    python3 evidence/d788-sweep-sourcing.py [-o evidence/d788-sourcing-sweep.json]
...
OUT = ROOT / "hardware/demo/manufacturing/evidence/d788-sourcing-sweep.json"
FIRST_FIVE = 5
