#!/usr/bin/env python3
"""D-791 -- re-sweep every exact MPN on the RELEASED assembly BOM, live.
...
it cannot.
    ...
    python3 evidence/d790-sweep-sourcing.py [-o evidence/d791-sourcing-sweep.json]
...
OUT = ROOT / "hardware/demo/manufacturing/evidence/d791-sourcing-sweep.json"
FIRST_FIVE = 5
