#!/usr/bin/env python3
"""Atomically route and gate the fitted display-backlight strap tree."""
...
LEGS = ("DISP_BL_STRAP_U1_TP2", "DISP_BL_STRAP_TP2_R109", "DISP_BL_STRAP_U1_R108")
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix="aqroot-demo-disp-bl-strap-") as temporary:
