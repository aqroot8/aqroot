#!/usr/bin/env python3
"""Atomically route and gate the fitted SX1262 chip-select tree."""
...
NET = "/SX1262_CS_N"
LEGS = ("SX1262_CS_MCU_PULLUP", "SX1262_CS_MCU_RADIO")
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix="aqroot-demo-sx1262-cs-") as temporary:
