#!/usr/bin/env python3
"""Route and fully gate the five-land display LED_A distribution tree."""
...
CHAIN = ("LED_A_R73_R70", "LED_A_R70_R72", "LED_A_R72_R71", "LED_A_R71_J1")
LEG_ORDERS = (CHAIN, tuple(reversed(CHAIN)))
